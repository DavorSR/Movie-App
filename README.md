Simple movies data app where API provided by [TDMB](https://www.themoviedb.org/) is used to fetch: images, descriptions, name etc for every movie, movies are show by random order.
